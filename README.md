...
5.If the letters are in different rows and columns, form a rectangle and replace the letters with the opposite corners of the rectangle, keeping the same row for each letter.
